...
inline std::string video_path(const std::string& name) {return data_path() + "/videos/" + std::string(name);};
...
const float renderScaleModifier = 100.f;
